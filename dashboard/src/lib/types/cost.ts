import { CostSummary } from "./ssd";

// Re-export for convenience
export type { CostSummary };

// Cost estimate can come from either a standalone cost-estimate.yaml
// or be extracted from the SSD's cost_summary field
